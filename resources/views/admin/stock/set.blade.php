<form class="form-horizontal ajax" action="{{ url('/admin/stock/set/' . $product->id ) }}" method="post">
  ...
  <div class="modal-body form">
    <div class="form-body">
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type="text" class="form-control input-large" name="change" value="1">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-3 control-label">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control input-large" name="unit_cost">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-3 control-label">
